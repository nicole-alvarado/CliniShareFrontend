...
export async function getEmailFromTemplate(codigo){    
    ...
    <body style="background-color: #e9ecef;">
      ...
      <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
        CliniShare: Código de confirmación de email.
      </div>
      <!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                  <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Confirme su dirección de email</h1>
                </td>
              </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
                    ...
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                <a href="#paginaClinishare" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Haga click aquí para confirmar</a>
                            </td>
                            </tr>
                        </table>
                        </td>
